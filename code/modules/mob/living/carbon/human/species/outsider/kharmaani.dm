/datum/species/kharmaani
	...
	After many years of rough skirmish and little communication, the Alliance of Racial Federations and the Mantids struck a commerce deal; allowing free \
	trade and travel between their respective planets, stations, ships, and other territories."

	icobase = 'icons/arfs_icon/mob/alate/r_alate.dmi'
	deform = 'icons/arfs_icon/mob/alate/r_alate.dmi'
	damage_overlays = 'icons/arfs_icon/mob/alate/dam_kharmaani_alate.dmi'
	blood_mask = 'icons/arfs_icon/mob/alate/blood_kharmaani_alate.dmi'
...
/datum/species/kharmaani/gyne
	...
	icobase = 'icons/arfs_icon/mob/gyne/r_gyne.dmi'
	deform = 'icons/arfs_icon/mob/gyne/r_gyne.dmi'
	icon_template = 'icons/arfs_icon/mob/gyne/r_gyne.dmi'
	damage_overlays = 'icons/arfs_icon/mob/gyne/dam_kharmaani_gyne.dmi'
	damage_mask = 'icons/arfs_icon/mob/gyne/dam_mask_kharmaani_gyne.dmi'
	blood_mask = 'icons/arfs_icon/mob/gyne/blood_kharmaani_gyne.dmi'
